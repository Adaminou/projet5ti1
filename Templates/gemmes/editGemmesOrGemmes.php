...
<h1>Ajouter une gemme</h1>
    <form action="" method="post">
            ...
            <div class="mb-3">
                ...
                <input name="nom" type="text" id="nom" placeholder="Nom" class="form-control" value="<?php if (isset($gemmes)) : ?><?= $gemmes->gemmesNom ?><?php endif ?>">
            ...
            <div class="mb-3">
                ...
                <input name="lieu" type="text" id="lieu" placeholder="Lieu" class="form-control" value="<?php if (isset($gemmes)) : ?><?= $gemmes->gemmesLieu ?><?php endif ?>">
            ...
            <div class="mb-3">
                ...
                <input name="image" type="text" id="image" placeholder="Lien" class="form-control" value="<?php if (isset($gemmes)) : ?><?= $gemmes->gemmesImage ?><?php endif ?>">
            ...
            <div class="mb-3" class="form-label">
                ...
                <input name="prix" type="number" id="prix" placeholder="Prix" class="form-control" value="<?php if (isset($gemmes)) : ?><?= $gemmes->gemmesPrix ?><?php endif ?>">
            ...
            <div class="mb-3" class="form-label">
                ...
                <input name="description" type="text" id="description" placeholder="Description" class="form-control" value="<?php if (isset($gemmes)) : ?><?= $gemmes->gemmesDescription ?><?php endif ?>">
        ...
        <div>
            <div class="Add">
                <button name="btnEnvoi" class="btn btn-primary" value="envoyer"><?php if(isset($gemmes)) : ?>Modifier <?php else : ?>Ajouter<?php endif ?></button>
        </div>
</form>